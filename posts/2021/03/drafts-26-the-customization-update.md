...
![](/images/Jayson-and-Pastel.png "Creating themes and syntaxes is great when using both Jayson and Pastel on the iPad with a keyboard and trackpad.")
...
![](/images/Drafts-26-Theme-Options.png "My current theme options")
...
![](/images/Twitter-Markup.png "Twitter markup is nice for when you don't want to be on Twitter.")
...
<video controls>
    <source src="/images/Task-Mark-Demo.mp4" type="video/mp4">
...
![](/images/Drafts-26-Syntax-Highlighting-Differences.png "Nahumck Dark theme in Markdown, MultiMarkdown, and Draftsdown syntaxes. Note the small, but meaningful differences between them.")
